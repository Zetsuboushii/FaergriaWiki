...
|-------|----------|-------------------|-----------------------------------|
| Untot | Wasser   | Lightning, Poison | Fire, Poison, Poisoned, Exhausted |
...
| Typ   | Weakness | Resistances | Immunities            |
|-------|----------|-------------|-----------------------|
| Untot | Heilig   |             | Gift, Erschöpft, Gift |
...
| Action      | Description                   | Attack       | Damage           |
|-------------|-------------------------------|--------------|------------------|
| Bissangriff | Melee, Reach 5 ft.            | +3 to hit    | 1d6+1 piercing   |
| Eisgeheul   | 20 ft. radius, einmal pro Tag | Wisdom DC 13 | 2d8 cold, freeze |
...
| HP | AC | Move   | Str | Dex | Con | Int | Wis | Cha |
|----|----|--------|-----|-----|-----|-----|-----|-----|
| 45 | 16 | 20 ft. | +2  | +0  | +3  | -2  | +1  | -2  |

| Typ   | Weakness      | Resistances | Immunities                             |
|-------|---------------|-------------|----------------------------------------|
| Untot | Heilige Magie |             | Poison, Acid, Betäubt, Erschöpft, Gift |

| Ability              | Description                                                                  |
|----------------------|------------------------------------------------------------------------------|
| Untote Zähigkeit     | Kann Schaden ignorieren, der ihn auf 0 HP reduzieren würde.                  |
| Unheimlicher Angriff | Ein geisterhafter Angriff, der zusätzlichen Nekrotischen Schaden verursacht. |

| Action               | Description                                                   | Attack       | Damage            |
|----------------------|---------------------------------------------------------------|--------------|-------------------|
| Schwertschlag        | Melee, Reach 5 ft., ein Ziel                                  | +4 to hit    | 1d6+2 slashing    |
...
| Typ   | Weakness | Resistances                                                 | Immunities                      |
|-------|----------|-------------------------------------------------------------|---------------------------------|
| Untot | Heilig   | Bludgeoning, Piercing, and Slashing from Nonmagical Attacks | Gift, Erschöpft, Betäubt, Charm |

| Ability             | Description                                                                            |
|---------------------|----------------------------------------------------------------------------------------|
| Ätherisches Driften | Kann durch Gegenstände und Wände fliegen ohne Angriffe von Gelegenheit zu provozieren. |
